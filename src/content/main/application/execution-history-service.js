import * as exportApi from '#src/content/main/application/execution-history-export.js';
import * as recordApi from '#src/content/main/application/execution-history-record.js';
import * as retentionApi from '#src/content/main/application/execution-history-retention.js';
...
export { createExecutionHistoryService };
