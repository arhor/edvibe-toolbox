(function initializeExecutionHistoryRepository(root, factory) {
    if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('./indexeddb.js'), require('./execution-history-record.js'));
    } else {
        root.EdVibeExecutionHistoryRepository = factory(root.EdVibeIndexedDb, root.EdVibeExecutionHistoryRecord);
    }
