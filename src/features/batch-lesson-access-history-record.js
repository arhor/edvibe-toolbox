(function initializeBatchLessonAccessHistoryRecord(root, factory) {
    if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('./batch-lesson-access-history-model.js'));
    } else {
        root.EdVibeBatchLessonAccessHistoryRecord = factory(root.EdVibeBatchLessonAccessHistoryModel);
    }
