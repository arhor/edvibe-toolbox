(function initializeBatchSectionCreationHistory(root, factory) {
    if (typeof module === 'object' && module.exports) {
        module.exports = factory(
            require('./batch-section-creation-history-model.js'),
            require('./batch-section-creation-history-record.js'),
            root
        );
    } else {
        root.EdVibeBatchSectionCreationHistory = factory(
            root.EdVibeBatchSectionCreationHistoryModel,
            root.EdVibeBatchSectionCreationHistoryRecord,
            root
        );
    }
