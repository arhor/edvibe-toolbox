...
`,Ue=e=>(t,n)=>{n===void 0?customElements.define(e,t):n.addInitializer(()=>{customElements.define(e,t)})},We={attribute:!0,type:String,converter:m,reflect:!1,hasChanged:h},Ge=(e=We,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function X(e){return(t,n)=>typeof n==`object`?Ge(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}var Ke=c`
    :host {
        display: block;
    }
...
`;function Z(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var Je=`popup-tool-card`,Q=class extends W{constructor(...e){super(...e),this.tool={},this.pageContext={type:`loading`},this.exportInProgress=!1,this.pendingToolId=null}static{this.styles=[Y,qe]}get toolViewModel(){return He(this.tool,{pageContext:this.pageContext,exportInProgress:this.exportInProgress,pendingToolId:this.pendingToolId})}activate(){let{id:e,disabled:t}=this.toolViewModel;t||!e||this.dispatchEvent(new CustomEvent(`popup-tool-activate`,{detail:{toolId:e},bubbles:!0,composed:!0}))}render(){let{id:e,title:t,description:n,appearance:r,busyLabel:i,disabled:a,reason:o,busy:s}=this.toolViewModel;return N`
            <button
                type="button"
                data-tool-id=${e}
                data-danger=${r===`danger`?`true`:F}
                ?disabled=${a}
                @click=${this.activate}
            >
                <span class="tool-card-header">
                    <span class="tool-copy">
                        ...
                        ${o?N`<span class="tool-requirement">${o}</span>`:F}

                        ${s?N`<span class="tool-busy">${i}</span>`:F}
                    </span>
                </span>
            </button>
        `}};Z([X({attribute:!1})],Q.prototype,`tool`,void 0),Z([X({attribute:!1})],Q.prototype,`pageContext`,void 0),Z([X({type:Boolean})],Q.prototype,`exportInProgress`,void 0),Z([X({attribute:!1})],Q.prototype,`pendingToolId`,void 0),Q=Z([Ue(Je)],Q);var Ye=`popup-tool-group`,$=class extends W{constructor(...e){super(...e),this.title=``,this.tools=[],this.pageContext={type:`loading`},this.exportInProgress=!1,this.pendingToolId=null}static{this.styles=[Y,Ke]}render(){return N`
        ...
        `}};Z([X({type:String})],$.prototype,`title`,void 0),Z([X({attribute:!1})],$.prototype,`tools`,void 0),Z([X({attribute:!1})],$.prototype,`pageContext`,void 0),Z([X({type:Boolean})],$.prototype,`exportInProgress`,void 0),Z([X({attribute:!1})],$.prototype,`pendingToolId`,void 0),$=Z([Ue(Ye)],$);async function Xe(){let[e]=await chrome.tabs.query({active:!0,currentWindow:!0});return Re(e)}async function Ze(){return!!(await chrome.storage.local.get(`exportInProgress`)).exportInProgress}function Qe(e,t){let n={action:t};return Me(n)?new Promise((t,r)=>{chrome.tabs.sendMessage(e,n,e=>{chrome.runtime.lastError?r(Error(chrome.runtime.lastError.message)):t(e)})}):Promise.reject(Error(`Unsupported Toolbox command.`))}function $e(e){let t=t=>{Ne(t)&&e(t)};return chrome.runtime.onMessage.addListener(t),()=>chrome.runtime.onMessage.removeListener(t)}var et=`popup-app`,tt=class extends W{static styles=[Y,Ce];static properties={pageContext:{state:!0},initialized:{state:!0},exportInProgress:{state:!0},pendingToolId:{state:!0},status:{state:!0}};constructor(){super(),this.pageContext={type:`loading`},this.initialized=!1,this.exportInProgress=!1,this.pendingToolId=null,this.status=null,this.connectionVersion=0,this.exportStatusObserved=!1,this.unsubscribeFromExportStatus=null}connectedCallback(){super.connectedCallback();let e=++this.connectionVersion;this.exportStatusObserved=!1,this.unsubscribeFromExportStatus=$e(e=>{this.handleExportStatus(e)}),this.initialize(e)}disconnectedCallback(){this.connectionVersion+=1,this.unsubscribeFromExportStatus?.(),this.unsubscribeFromExportStatus=null,super.disconnectedCallback()}async initialize(e){let[t,n]=await Promise.allSettled([Xe(),Ze()]);e!==this.connectionVersion||!this.isConnected||(this.pageContext=t.status===`fulfilled`?t.value:{type:`unavailable`},n.status===`fulfilled`&&!this.exportStatusObserved&&(this.exportInProgress=n.value),this.initialized=!0)}handleExportStatus(e){this.exportStatusObserved=!0,this.exportInProgress=e.state===q.STARTED,e.state===q.COMPLETE?this.status={message:`Экспорт завершён.`,isError:!1}:e.state===q.ERROR&&(this.status={message:e.message||`Не удалось экспортировать марафон.`,isError:!0})}async executeTool(e){let t=Ve(e);if(!t||Be(t,this.pageContext)||!this.pageContext.tabId||this.exportInProgress||this.pendingToolId!==null)return;this.status=null,this.pendingToolId=t.id,t.id===`marathon-export`&&(this.exportInProgress=!0);let n=this.connectionVersion;try{if(await Qe(this.pageContext.tabId,t.command),n!==this.connectionVersion||!this.isConnected)return;this.pendingToolId=null,t.closeOnSuccess&&window.close()}catch(e){if(n!==this.connectionVersion||!this.isConnected)return;t.id===`marathon-export`&&(this.exportInProgress=!1),this.pendingToolId=null,this.status={message:e.message||`Не удалось запустить инструмент.`,isError:!0}}}handleToolActivate(e){this.executeTool(e.detail.toolId)}render(){let e=ze(this.pageContext);return N`
        ...
        `}};customElements.define(et,tt),t(document.documentElement);