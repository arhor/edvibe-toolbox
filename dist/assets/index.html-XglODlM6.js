...
`;function X(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var et=`popup-tool-card`,Z=class extends V{constructor(...e){super(...e),this.tool={},this.pageContext={type:`loading`},this.exportInProgress=!1,this.pendingToolId=null}static{this.styles=[Y,$e]}get toolViewModel(){return Ze(this.tool,{pageContext:this.pageContext,exportInProgress:this.exportInProgress,pendingToolId:this.pendingToolId})}activate(){let{id:e,disabled:t}=this.toolViewModel;t||!e||this.dispatchEvent(new CustomEvent(`popup-tool-activate`,{detail:{toolId:e},bubbles:!0,composed:!0}))}render(){let{id:e,title:t,description:n,appearance:r,busyLabel:i,disabled:a,reason:o,busy:s}=this.toolViewModel;return j`
        ...
        `}};X([U({attribute:!1})],Z.prototype,`tool`,void 0),X([U({attribute:!1})],Z.prototype,`pageContext`,void 0),X([U({type:Boolean})],Z.prototype,`exportInProgress`,void 0),X([U({attribute:!1})],Z.prototype,`pendingToolId`,void 0),Z=X([H(et)],Z);var tt=`popup-tool-group`,Q=class extends V{constructor(...e){super(...e),this.title=``,this.tools=[],this.pageContext={type:`loading`},this.exportInProgress=!1,this.pendingToolId=null}static{this.styles=[Y,Qe]}render(){return j`
        ...
        `}};X([U({type:String})],Q.prototype,`title`,void 0),X([U({attribute:!1})],Q.prototype,`tools`,void 0),X([U({attribute:!1})],Q.prototype,`pageContext`,void 0),X([U({type:Boolean})],Q.prototype,`exportInProgress`,void 0),X([U({attribute:!1})],Q.prototype,`pendingToolId`,void 0),Q=X([H(tt)],Q);async function nt(){let[e]=await chrome.tabs.query({active:!0,currentWindow:!0});return Je(e)}async function rt(){return!!(await chrome.storage.local.get(`exportInProgress`)).exportInProgress}function it(e,t){let n={action:t};return He(n)?new Promise((t,r)=>{chrome.tabs.sendMessage(e,n,e=>{chrome.runtime.lastError?r(Error(chrome.runtime.lastError.message)):t(e)})}):Promise.reject(Error(`Unsupported Toolfox command.`))}function at(e){let t=t=>{Ue(t)&&e(t)};return chrome.runtime.onMessage.addListener(t),()=>chrome.runtime.onMessage.removeListener(t)}var ot=`popup-app`,$=class extends V{constructor(...e){super(...e),this.pageContext={type:`loading`},this.initialized=!1,this.exportInProgress=!1,this.pendingToolId=null,this.status=null,this.connectionVersion=0,this.exportStatusObserved=!1,this.unsubscribeFromExportStatus=null}static{this.styles=[Y,Me]}connectedCallback(){super.connectedCallback();let e=++this.connectionVersion;this.exportStatusObserved=!1,this.unsubscribeFromExportStatus=at(e=>this.handleExportStatus(e)),this.initialize(e)}disconnectedCallback(){this.connectionVersion+=1,this.unsubscribeFromExportStatus?.(),this.unsubscribeFromExportStatus=null,super.disconnectedCallback()}async initialize(e){let[t,n]=await Promise.allSettled([nt(),rt()]);e!==this.connectionVersion||!this.isConnected||(this.pageContext=t.status===`fulfilled`?t.value:{type:`unavailable`},n.status===`fulfilled`&&!this.exportStatusObserved&&(this.exportInProgress=n.value),this.initialized=!0)}handleExportStatus(e){switch(this.exportStatusObserved=!0,this.exportInProgress=e.state===q.STARTED,e.state){case q.COMPLETE:this.status={message:`Экспорт завершён.`,isError:!1};break;case q.ERROR:this.status={message:e.message||`Не удалось экспортировать марафон.`,isError:!0}}}async executeTool(e){let t=Xe(e),n=`tabId`in this.pageContext?this.pageContext.tabId:void 0;if(!t||J(t,this.pageContext)||n===void 0||this.exportInProgress||this.pendingToolId!==null)return;this.status=null,this.pendingToolId=t.id,t.id===`marathon-export`&&(this.exportInProgress=!0);let r=this.connectionVersion;try{if(await it(n,t.command),r!==this.connectionVersion||!this.isConnected)return;this.pendingToolId=null,t.closeOnSuccess&&window.close()}catch(e){if(r!==this.connectionVersion||!this.isConnected)return;t.id===`marathon-export`&&(this.exportInProgress=!1),this.pendingToolId=null,this.status={message:e instanceof Error?e.message:`Не удалось запустить инструмент.`,isError:!0}}}handleToolActivate(e){this.executeTool(e.detail.toolId)}render(){let e=Ye(this.pageContext);return j`
        ...
        `}};X([W()],$.prototype,`pageContext`,void 0),X([W()],$.prototype,`initialized`,void 0),X([W()],$.prototype,`exportInProgress`,void 0),X([W()],$.prototype,`pendingToolId`,void 0),X([W()],$.prototype,`status`,void 0),$=X([H(ot)],$),t(document.documentElement);