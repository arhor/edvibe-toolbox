...
//#endregion
//#region src/components/popup-tool-list.js
var PopupToolCard = class extends i {
	static properties = { configuration: { state: true } };
	constructor() {
		super();
		this.configuration = {};
	...
	get onExecute() {
		return typeof this.configuration?.onExecute === "function" ? this.configuration.onExecute : null;
	}
	activate() {
		if (this.disabled || !this.onExecute || !this.toolId) return;
	...
	updated(changedProperties) {
		if (changedProperties.has("configuration")) this.syncHostState();
	}
	render() {
...
var PopupToolGroup = class extends i {
	static properties = { configuration: { state: true } };
	constructor() {
		super();
		this.configuration = {};
...
var pageContextElement = document.getElementById("pageContext");
var pageContextTitle = document.getElementById("pageContextTitle");
var pageContextDescription = document.getElementById("pageContextDescription");
var toolGroupsElement = document.getElementById("toolGroups");
var popupStatusElement = document.getElementById("popupStatus");
var activeTab = null;
var pageContext = { type: "loading" };
...
async function getPageContext() {
	...
	if (!(url.hostname === "edvibe.com" || url.hostname.endsWith(".edvibe.com"))) return {
		type: "unsupported",
		tab
	};
