(function initializeCompileMarathonToZip(root, factory) {
    const api = factory();
    root.EdVibeCompileMarathonToZip = api;

    if (typeof module === 'object' && module.exports) {
        module.exports = api;
    }
})(typeof globalThis !== 'undefined' ? globalThis : window, function createCompileMarathonToZipModule() {
    'use strict';
    ...
    console.log('[Edvibe Toolbox][Zip] Marathon ZIP compiler module initialized.');
